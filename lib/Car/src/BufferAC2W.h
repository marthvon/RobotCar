...
namespace Car {
    namespace Buffer {
        ...
        public:
            constexpr BufferAC2W(AnalogCar2W& p_car);
            constexpr BufferAC2W(AnalogCar2W&& p_car);
            constexpr BufferAC2W(const uint8_t p_forwardLeftWheel, const uint8_t p_backwardLeftWheel, const uint8_t p_forwardRightWheel, const uint8_t p_backwardRightWheel);
            ~BufferAC2W();
